...
const COPY = {
  zh: { activated: 'IKUN MODE ACTIVATED', tagline: '懂的都懂' },
  en: { activated: 'IKUN MODE ACTIVATED', tagline: 'If you know, you know' },
} as const

export default function IkunEasterEgg({ isDarkMode, lang = 'en' }: Props) {
